...
internal class CoreUITest: MonoBehaviour
{
    ...
    protected virtual void Start()
    {
        ...
        var w = CoreUIEditor.Instance.Window(new Rect(5*_pixelSize, -5*_pixelSize, _pixelSize * 290, _pixelSize * 290), _window, "OS Window Style");
        ...
        CoreUIEditor.Instance.TextField(new Rect(0, -5 * _pixelSize, 100 * _pixelSize, 0), "Test", new Color(.25f, .25f, .25f, 1f), new Color(.25f, .25f, .25f, 1f),
            sc0, "TextFieldCursorFlexibleImageStyle","Wave Font");
